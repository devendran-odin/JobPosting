    ...
    if (validateForm()) {
      ...
      try {
        ...
        if (response.status === 201) {
          ...
          toast.error(
            "Failed to create job opening. Unexpected status: " +
              response.status
          );
        }
      } catch (error) {
  ...
  return (
    <>
      <div className="w-[848px] h-[785px] border rounded-[16px] bg-white shadow-md p-3">
        <h1 className="text-[24px] font-[700] text-center mt-5 text-[#222222] mb-10">
          Create Job Opening
        </h1>
        <div className="px-8">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="block text-[20px] font-[600] text-[#222222] mb-2">
                Job Title
              </label>
              <input
                type="text"
            ...
            <div>
              ...
              >
                ...
                <SelectContent className="bg-white">
                  ...
                  <SelectItem value="Mumbai" className="text-[16px] font-[500]">
                    Mumbai
                  </SelectItem>
                  <SelectItem value="Pune" className="text-[16px] font-[500]">
                    Pune
                  </SelectItem>
                  <SelectItem value="Delhi" className="text-[16px] font-[500]">
                    Delhi
                  </SelectItem>
                </SelectContent>
              </Select>
